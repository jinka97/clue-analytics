    ...
    <nav className="bg-white shadow-md sticky top-0 z-50 px-6 py-4">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
        ...
        <div className="space-x-6">
          ...
          <Link to="/case-studies" className={location.pathname === "/case-studies" ? "text-blue-600 font-semibold" : "text-gray-700 hover:text-blue-600 transition"}>Case Studies</Link>
          ...
          <Link to="/privacy-policy" className={location.pathname === "/privacy-policy" ? "text-blue-600 font-semibold" : "text-gray-700 hover:text-blue-600 transition"}>Privacy Policy</Link>
         {/*<Link to="/admin" className={location.pathname === "/admin" ? "text-blue-600 font-semibold" : "text-gray-700 hover:text-blue-600 transition"}>Admin</Link> */}
        </div>
      </div>
    </nav>
  );
